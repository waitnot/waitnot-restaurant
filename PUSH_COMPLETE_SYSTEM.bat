...
if %ERRORLEVEL% EQU 0 (
    ...
    echo    - Ensure you're using a valid Personal Access Token
    echo    - Token must have 'repo' permissions
    echo    - Use token as password, not your GitHub password
    echo.
    echo Option 2: Check Git Configuration
    ...
    echo.
    echo Option 4: Check Repository URL
    echo    - Run: git remote -v
    echo    - Ensure origin points to correct GitHub repository
    echo.
)
